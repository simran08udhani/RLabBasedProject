      ...
      tabsetPanel(
        ...
        tabPanel("Visualization",
                 fluidPage(
                   ...
                   # Add an action button for updating the chart
                   column(
                     offset = 4,
                     actionButton("update_visualization", "Update Chart"),
                     br(),
                     width = 10
                   )
                   ),
        ...
        tabPanel("3D Visualization",
                 fluidPage(
                   ...
                   # Add an action button for updating the 3D visualization
                   column(
                     offset = 4,
                     actionButton("update_3d_visualization", "Update 3D Chart"),
                     br(),
                     width = 11
                   )
                   ...
                   br(),
                   withLoader(rglwidgetOutput("rgl_plot")),
                   withLoader(plotOutput("visualization_3d"))
                 )
        ),
